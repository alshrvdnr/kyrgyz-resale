...
function toggleFav(id) {
    ...
    if(modalIcon) {
        if(favs.includes(id)) {
            modalIcon.classList.remove('fa-regular'); modalIcon.classList.add('fa-solid'); modalIcon.style.color = "var(--pink)";
        } else {
            modalIcon.classList.remove('fa-solid'); modalIcon.classList.add('fa-regular'); modalIcon.style.color = "var(--pink)";
        }
    }
}
