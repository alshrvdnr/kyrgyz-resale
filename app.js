  ...
  function getAdImageUrl(adObj) {
    ...
    for (let c of candidates) {
      if (c && typeof c === "string") {
        ...
        if (trimmed !== "" && trimmed !== "null" && trimmed !== "undefined" && trimmed !== "[object Object]" && !trimmed.startsWith("blob:")) {
          return trimmed;
        }
      }
    }
...
const i18nDict = {
  ru: {
    heroTitlePrefix: "Букеты и подарки —",
    ...
    footerAbout: "Букеты и подарки от людей в вашем городе. Контакт, передача и оплата — напрямую между сторонами.",
